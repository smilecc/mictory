...
-- AddForeignKey
ALTER TABLE `Room` ADD CONSTRAINT `Room_channelCategoryId_fkey` FOREIGN KEY (`channelCategoryId`) REFERENCES `ChannelCategory`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

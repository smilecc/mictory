...
import { ChannelUpdateOneRequiredWithoutRoomsNestedInput } from '../channel/channel-update-one-required-without-rooms-nested.input';
...
export class RoomUpdateInput {
    ...
    @Field(() => ChannelUpdateOneRequiredWithoutRoomsNestedInput, {nullable:true})

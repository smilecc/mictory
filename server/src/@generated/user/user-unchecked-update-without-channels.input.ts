...
import { ChannelUncheckedUpdateManyWithoutOwnerUserNestedInput } from '../channel/channel-unchecked-update-many-without-owner-user-nested.input';

@InputType()
export class UserUncheckedUpdateWithoutChannelsInput {
    ...
    @Field(() => ChannelUncheckedUpdateManyWithoutOwnerUserNestedInput, {nullable:true})
    ownedChannels?: ChannelUncheckedUpdateManyWithoutOwnerUserNestedInput;
}

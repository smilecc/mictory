...
func (uq *UserQuery) QueryOwner() *ChannelQuery {
...
func (uq *UserQuery) WithOwner(opts ...func(*ChannelQuery)) *UserQuery {
	query := (&ChannelClient{config: uq.config}).Query()
...
func (uq *UserQuery) loadOwner(ctx context.Context, query *ChannelQuery, nodes []*User, init func(*User), assign func(*User, *Channel)) error {
